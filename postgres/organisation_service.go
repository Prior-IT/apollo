...
func (o *OrganisationService) UpdateOrganisation(
	...
	return o.UpdateOrganisationTx(ctx, o.db, organisationID, name)
}

// Calls UpdateOrganisation query
func (o *OrganisationService) UpdateOrganisationTx(
	ctx context.Context,
	dbtx sqlc.DBTX,
	organisationID core.OrganisationID,
	name string,
	...
	err := queries.UpdateOrganisation(ctx, intID, name)
	if err != nil {
